...
export const MATRA = [
  ...
  // ─── กลุ่ม 2: สระเดี่ยว (ต่อ) — เติมคู่ยาว-สั้น เอ/เอะ, อือ/อึ + โอ, เออ ─────
  {
    ...
    bubbles: ['ล','พ','ส','ก','ม','ว'],
    words: [
      { display:'เล่น', lead:'ล', sara:'เ', spell:['ลอ','เอ','นอ','เล่น'] },   // เล่นเกม
      { display:'เพลง', lead:'พ', sara:'เ', spell:['พอ','เอ','งอ','เพลง'] },   // ร้องเพลง
      { display:'เส้น', lead:'ส', sara:'เ', spell:['สอ','เอ','นอ','เส้น'] },   // เส้นก๋วยเตี๋ยว
      { display:'เก่ง', lead:'ก', sara:'เ', spell:['กอ','เอ','งอ','เก่ง'] },   // เก่งมาก
      { display:'เม่น', lead:'ม', sara:'เ', spell:['มอ','เอ','นอ','เม่น'] },   // ตัวเม่น
      { display:'เว้น', lead:'ว', sara:'เ', spell:['วอ','เอ','นอ','เว้น'] },   // เว้นวรรค
    ],
  },
  {
    id: 'sara_e_short',
  ...
  },
  {
    ...
    words: [
      ...
      { display:'ผึ้ง', lead:'ผ', sara:'ึ', spell:['ผอ','อึ','งอ','ผึ้ง'] },   // ผึ้งน้อย
  ...
  },
  {
    ...
    bubbles: ['ก','ข','ฟ','ป','ม','ว'],
    words: [
      { display:'ไก่', lead:'ก', sara:'ไ', spell:['กอ','ไอ','ไก่'] },   // ไก่
      { display:'ไข่', lead:'ข', sara:'ไ', spell:['ขอ','ไอ','ไข่'] },   // ไข่
      { display:'ไฟ', lead:'ฟ', sara:'ไ', spell:['ฟอ','ไอ','ไฟ'] },    // ไฟ
      { display:'ไป', lead:'ป', sara:'ไ', spell:['ปอ','ไอ','ไป'] },    // ไป
      { display:'ไม้', lead:'ม', sara:'ไ', spell:['มอ','ไอ','ไม้'] },   // ไม้
