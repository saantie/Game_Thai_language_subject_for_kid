...
export const SKILLS = [
  ...
  },
  {
    ...
    // px ต่อเฟรม — v203 เคยหาร 50% (1.3) แต่ผู้ใช้บอกว่าช้าเกินไป → คืนค่าเดิม
    // (ลูกสมุน v203 ยังช้าเหมือนเดิม — ***ทุกระดับต้องมากกว่าความเร็วไล่ลูกสมุนสูงสุด 1.05*** อยู่แล้ว สบายขึ้นด้วยซ้ำ)
