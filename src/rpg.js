...
export const SKILLS = [
  ...
  },
  {
    ...
    // px ต่อเฟรม — v203 เคยหาร 50% (1.3) แต่ผู้ใช้บอกว่าช้าเกินไป → คืนค่าเดิม (v207: 2.6-3.8)
    // v209: ผู้ใช้บอกยังช้าอีก → เพิ่มอีก ~30% (ลูกสมุนไวสุด 1.30×diff.speed สูงสุด 1.05 = 1.365
    // ***ทุกระดับต้องมากกว่านี้เสมอ*** เหลือ margin เยอะมากอยู่แล้วที่ 3.4 ขึ้นไป)
    maxRank: 3, levels: [3.4, 3.8, 4.2, 4.6],
