    ...
    recog.start(
      ...
      () => {
        ...
        if (!got && state === 'LISTENING') {
          setState('READING');
          // ไมค์ตัดจบโดยไม่ทันได้ยิน (เด็กพูดไม่ทัน/เริ่มช้า) — แม่มดบอก "ลองอ่านอีกครั้ง"/
          // "ลองใหม่อีกครั้ง" แล้วเปิดไมค์ให้อัตโนมัติ ไม่ต้องให้เด็กกดปุ่มเอง จำกัดไว้ไม่เกิน
