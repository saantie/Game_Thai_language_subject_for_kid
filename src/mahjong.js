// mahjong.js — มินิเกม "ไพ่นกกระจอกจับคู่คำไทย"
// เข้าเล่นจาก "ไอเทมมินิเกมจับคู่ไพ่" ที่หล่นบนแผนที่ (worldMap onCardsCollected) เท่านั้น —
// ด่านละ 1 ครั้ง (การันตี) + โอกาสหล่นสุ่มจากลูกสมุน · เล่นจับคู่ครบทั้งกระดาน → onComplete
// → main.js เปิดการ์ดให้เลือกไอเทมพลังวิเศษ 1 ชิ้น (showMahjongReward)
//
